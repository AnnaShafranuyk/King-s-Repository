	...
	public partial class ShopForm : Form
	{
		...
		public ShopForm(ShopControl _sControl,Person _user,Library _libr)
		{
			...
			for (int i = 0; i < pblist.Count; i++)
			{
				...
				string src = @"E:\Registration\Registration\Registration\pictures\" + i.ToString() + ".jpg";
				...
				src = @"E:\Registration\Registration\Registration\pictures\" + i.ToString() + i.ToString()  + ".png";
				string src3 = @"E:\Registration\Registration\Registration\pictures\" + i.ToString() + i.ToString() + i.ToString() + ".png";
				t1.Add(src);
				t2.Add(text[i]);
				t3.Add(src3);
				initializeTabPage2();
  ...
  System.Windows.Forms.DrawItemEventArgs e)
		...
		private void initializeTabPage2()
		{
			...
			for (int i = 0 ; i < user.Glib.size(); i++)
			{
				...
				string src = @"E:\Registration\Registration\Registration\pictures\page2\" + user.Glib.getByIndex(i).Name + ".jpg";
				Image image = Image.FromFile(src);
